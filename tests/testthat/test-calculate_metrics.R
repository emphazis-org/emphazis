testthat::test_that("Prepare table", {
  ...
  position_table_head <- structure(list(x_center = c(
    ...
    NA,
    -6L
  ), class = c("tbl_df", "tbl", "data.frame"), emphazis_version = structure(list(c(0L, 0L, 0L, 9007L)), class = c(
    "package_version",
    "numeric_version"
  )), unit = "px", fps = 3, analysis_date = "210309-141548-UTC", arena_width = 365L, arena_height = 410L)
